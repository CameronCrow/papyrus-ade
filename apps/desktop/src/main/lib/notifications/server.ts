 ...
 * agent's chat-mastra tab in Papyrus so the user watches it work.
 *
...
app.post("/agent/invoke", async (req, res) => {
	...
	try {
		...
		// Intentionally do NOT foreground Papyrus or steal focus — invokes are
 ...
 * broadcast it so the feed pane updates live. This is Papyrus's local "Convex":
