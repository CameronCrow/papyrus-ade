...
/**
 * Papyrus agent creation runs as a background job so a slow clone never blocks the
...
/**
 * Retry a failed/interrupted agent init. Returns false if this is not an Papyrus
