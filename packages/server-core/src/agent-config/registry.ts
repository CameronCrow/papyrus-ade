 ...
 * reads CLAUDE.md + .claude/skills + MCP config), the Papyrus workspace that
...
export interface AgentRegistryEntry {
	...
	cwd: string;
	/** The Papyrus workspace id that surfaces this agent's session. */
	workspaceId: string;
...
/**
 * Reverse lookup: find the agent whose Papyrus workspace matches `workspaceId`.
